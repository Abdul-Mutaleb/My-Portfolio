...
/* ══════════════════════════════════════
   ...
   ══════════════════════════════════════ */
const PROJECTS = [
  {img:'./img/BikriZone.png',  bg:'linear-gradient(135deg,#0d9488,#059669)',cat:'Laravel',catIcon:'fa-brands fa-laravel',title:'BikriZone — E-Commerce Platform',desc:'A full e-commerce platform where buyers can browse products, add to cart, and checkout — while sellers manage their inventory and admins control everything from a powerful backend dashboard.',tags:['Laravel','React','MySQL','Bootstrap','JavaScript'],github:'https://github.com/Abdul-Mutaleb/BikriZone-Full-Stack-E-Commerce-Platform',demo:'https://bikrizone.logicthree.com/'},
  {img:'./img/Online_traffic_Management_System.png', bg:'linear-gradient(135deg,#059669,#14b8a6)',cat:'Laravel',catIcon:'fa-brands fa-laravel',title:'Online Traffic Offense Management System (OTMS)',desc:'Built for police departments to record traffic violations, issue fines, and verify vehicles digitally — with role-based access so each user sees only what they need.',tags:['Laravel','PHP','MySQL','Bootstrap','JavaScript'],github:'https://github.com/Abdul-Mutaleb/online-traffic-offense-management',demo:'https://www.otms.logicthree.com/login'},
  {img:'./img/WeatherNow.png', bg:'linear-gradient(135deg,#0ea5e9,#0d9488)',cat:'Frontend',catIcon:'fa-solid fa-code',title:'WeatherNow',desc:'A clean weather app that gives you real-time weather data for any city in the world. Just type a location and instantly see temperature, humidity, wind speed, and current conditions.',tags:['HTML','CSS','Bootstrap','JavaScript'],github:'https://github.com/Abdul-Mutaleb/WeatherNow',demo:'https://abdul-mutaleb.github.io/WeatherNow/'},
  {img:'./img/ExpenseTracker.png', bg:'linear-gradient(135deg,#7c3aed,#0d9488)',cat:'React',catIcon:'fa-brands fa-react',title:'Expense Tracker',desc:'A personal finance tracker built with React that helps you log daily expenses, categorize your spending, and get a clear picture of where your money actually goes.',tags:['React','Bootstrap','HTML','CSS','JavaScript'],github:'https://github.com/Abdul-Mutaleb/ExpenseTracker',demo:'https://abdul-mutaleb.github.io/ExpenseTracker/'},
  {img:null, bg:'linear-gradient(135deg,#0d9488,#5eead4)',icon:'fa-solid fa-briefcase',cat:'Frontend',catIcon:'fa-solid fa-code',title:'Portfolio Website',desc:'This very portfolio — built from scratch with smooth scroll animations, a typing effect, dynamic project filtering, and a design I genuinely spent time getting right.',tags:['HTML','CSS','Bootstrap','JavaScript'],github:'https://github.com/Abdul-Mutaleb',demo:'#'},
];

const cats     = ['All', ...new Set(PROJECTS.map(p => p.cat))];
const catIcons = {All:'fa-solid fa-border-all',Laravel:'fa-brands fa-laravel',Frontend:'fa-solid fa-code',React:'fa-brands fa-react'};
...
function renderProj(f = 'All') {
  ...
  g.innerHTML = list.map((p, i) => {
    ...
    const demoBtn   = hasDemo
      ? `<a href="${p.demo}" target="_blank" class="proj-action-btn proj-action-demo"><i class="fas fa-external-link-alt"></i> Live Demo</a>`
      : `<span class="proj-action-btn proj-action-demo proj-action-disabled"><i class="fas fa-external-link-alt"></i> Live Demo</span>`;
    const thumb = p.img
      ? `<img src="${p.img}" alt="${p.title}" class="proj-thumb-img">`
    ...
    <div class="proj-card">
      ...
      <div class="proj-body">
        ...
        <div class="proj-actions">
          <a href="${p.github}" target="_blank" class="proj-action-btn proj-action-github"><i class="fab fa-github"></i> GitHub</a>
          ${demoBtn}
        </div>
      </div>
    </div>
...
/* ══════════════════════════════════════
   TYPED TEXT
   ══════════════════════════════════════ */
const phrases = ['Full Stack React & Laravel Dev','React Frontend Developer','Laravel Backend Engineer','PHP & MySQL Specialist','RESTful API Developer','Full Stack Web Developer'];
